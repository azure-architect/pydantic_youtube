...
def export_report_to_json(report, output_file: str):
...
def export_keywords_to_csv(report, output_file: str):
...
def export_technologies_to_csv(report, output_file: str):
